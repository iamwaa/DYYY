...
#import "Sources/Core/CityManager.h"
#import "Sources/UI/DYYYBottomAlertView.h"
#import "Sources/UI/DYYYGlassConfirmView.h"
#import "Sources/Media/DYYYManager.h"

#import "Sources/Core/AWMSafeDispatchTimer.h"
#import "Sources/Core/DYYYConstants.h"
#import "DYYYFloatClearButton.h"
#import "Sources/Features/DYYYFloatSpeedButton.h"
#import "Sources/Features/DYYYLivePreStreamLayoutCoordinator.h"
#import "Sources/Features/DYYYLoginBypassManager.h"
#import "Sources/Features/DYYYHideMusicButtonHooks.h"
#import "Sources/Features/DYYYHideMessageAndMinePageHooks.h"
#import "Sources/Features/DYYYHideCommentAIAnalysisHooks.h"
#import "Sources/Features/DYYYHideTemplateCollectionHooks.h"
#import "Sources/Features/DYYYSearchKeyboardVoiceHooks.h"
#import "Sources/Features/DYYYHighFPSHooks.h"
#import "Sources/Features/DYYYFPSOverlay.h"
#import "Sources/Features/DYYYMiniProgramRewardBypass.h"
#import "Sources/Features/DYYYPrivacyRecordUploadGuard.h"
#import "Sources/Settings/DYYYSettingViewController.h"
...
static BOOL DYYYIsVideoRenderRelatedView(UIView *view) {
    ...
    return [viewClassName containsString:@"Player"] ||
           [viewClassName containsString:@"Metal"] ||
           [viewClassName containsString:@"Render"] ||
           [viewClassName containsString:@"Video"];
}

static void DYYYRelaxRichContentAncestorClippingIfNeeded(UIView *view, UIViewController *viewController, CGFloat targetHeight) {
    if (!view || targetHeight <= 0 || !DYYYIsVideoRenderRelatedView(view) || !DYYYViewControllerHasIMDetailOrRichContentParent(viewController)) {
        return;
    }
    ...
    for (NSInteger i = 0; ancestor && i < 8; i++) {
        ...
        if (ancestorHeight > 0 && ancestorHeight + 0.5 < targetHeight) {
...
- (void)setAttributedText:(NSAttributedString *)attributedText {
    if (attributedText.length > 0 && [NSStringFromClass([(id)self class]) containsString:@"AWECommentPanelListSwiftImpl"] &&
        [NSStringFromClass([(id)self class]) hasSuffix:@"BaseCellCommentLabel"] && DYYYGetBool(@"WaaEnableCommentColor")) {
        ...
        if ([scanner scanHexInt:&hexValue]) {
            ...
            NSLog(@"[DYYY][CommentAppearance][YYLabel] contentAttributedColorApplied class=%@ length=%lu text=\"%@\" color=%@", NSStringFromClass([(id)self class]), (unsigned long)coloredText.length, coloredText.string, commentColor);
        }
    }
...
- (void)layoutSubviews {
    ...
    if (enableFS) {
        if (DYYYIsVideoRenderRelatedView(self)) {
            DYYYRelaxRichContentAncestorClippingIfNeeded(self, vc, CGRectGetHeight(self.frame));
        }
...
- (void)setFrame:(CGRect)frame {
    ...
    if (((isPlayVC && !hasRichContentParent) || isIMDetailPlaybackView) && enableFS) {
